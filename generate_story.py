...
- Instagram: 連続ストーリー（5-10枚）、データドリブン、アンケート・スタンプ多用
...
パターン4: 組織論・マネジメント系
- ToDoベースコミュニケーション、感情はセンサー
- 週7コミット文化、ADHDでも活躍させる仕組み

パターン5: AI・生成AI系
- AI活用で作業効率半分以下
- AIは初心者ほど使った方がいい、創造性が大事
...
- 「〜よね」「〜だよね」「〜だわ」「〜かも」
- 「わーい！」（嬉しい時）
- 「マジで」「ガチで」「めちゃくちゃ」「やばい」「エグい」「最高」
- 「w」「笑」「運良かった」「負ける気がしない」

絶対に使わない表現（禁止）
- 「。」は文末に使わない
- 「〜やで」「〜やん」「〜やな」「〜や」（関西弁）
- 「めっちゃ」「ほんま」「ほんまに」「〜やと思う」（関西弁）
